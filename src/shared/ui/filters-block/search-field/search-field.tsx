...
export const SearchField = memo((props: SearchFieldProps): JSX.Element => {
  ...
  const onChangeSearchDebounced = utils.debounce((value: string) => {
    if (onChangeSearch) {
    ...
    <Flex>
      ...
      <Input
        ...
        suffix={
          <ConfigProvider wave={{ disabled: true }}>
            <Button
              icon={<Icon icon="CloseCircle" style={{ color: token.colorIcon }} />}
